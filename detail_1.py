        ...
        if "CD" in hrefString:
            ...
            for delink in links:
                ...
                for i in AsinList:
                    ...
                    nameList = []
                    extracted_data.append(divParser(url,nameList))
                    sleep(5)
                    print(nameList)            
                    list_set = set(nameList)
                    
                    for ite in list_set:
                        num = nameList.count(ite)
                        cd = "CD"
            ...
            next_page = page.xpath('//*[@id="search"]/div[1]/div[2]/div/span[7]/div/div/div/ul/li[7]/a/@href')                
            if next_page is not None:
                dynamic_url = urljoin(base_url, next_page[0])
